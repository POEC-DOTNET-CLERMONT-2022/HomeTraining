...
namespace Ipme.Hometraining.WPFClient
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public ExerciceService ExerciceService { get; } = new ExerciceService();
        ...
        private void ExercicesZone_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            TabItem newTabItem = new TabItem();
            ListBox lb = new ListBox();
            lb.ItemsSource = ExerciceService.GetExercices();
            newTabItem.Content = lb;
            ExercicesZone.Items.Add(newTabItem);
        }
